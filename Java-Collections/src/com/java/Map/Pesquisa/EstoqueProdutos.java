...
public class EstoqueProdutos {
    ...
    public static void main(String[] args) {
        ...
        estoqueProdutos.exibirProutos();

        estoqueProdutos.adicionarProduto(1L, "Produto A", 10, 5.0);
        estoqueProdutos.adicionarProduto(2L, "Produto B", 3, 15.0);
        estoqueProdutos.adicionarProduto(3L, "Produto C", 7, 12.0);
